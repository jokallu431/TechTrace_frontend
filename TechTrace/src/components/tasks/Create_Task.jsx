...
//         ? prev.accessories.filter((id) => id !== value)
//         : [...prev.accessories, value],
//     }));
//   };

//   console.log("before",taskData);
...
//         body: JSON.stringify({ ...taskData, task_Desc: [taskData.task_Desc], task_Status: "Pending" }),
//       });
...
//                         <button className="btn btn-light form-control text-start dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
...
//                               <input type="checkbox" className="form-check-input me-2" id={acc._id} value={acc._id} checked={taskData.accessories.includes(acc._id)} onChange={handleAccessoryChange} />
//                               <label className="form-check-label" htmlFor={acc._id}>{acc.accessories_Name}</label>
//                             </li>
//                           ))}
//                         </ul>
//                       </div>
